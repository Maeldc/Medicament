...
public class Medicament2Application {
	...
	public static void main(String[] args) {
		...
		medicament2DaoItf medicaments =  ctx.getBean(medicament2DaoItf.class);
		...
		medicaments.save(medicament1);
		medicaments.save(medicament2);
		medicaments.save(medicament3);
		medicaments.save(medicament4);
